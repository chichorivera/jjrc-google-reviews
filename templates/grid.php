...
<div class="jjrc-gr-wrap jjrc-gr-grid" id="<?php echo esc_attr( $uid ); ?>">
    ...
    <div class="jjrc-grid-container" data-per-page="3">
        <?php foreach ( $data['reviews'] as $review ) : ?>
            <div class="jjrc-review-card">
                ...
                <p class="jjrc-review-text" style="--jjrc-lines: <?php echo absint( $comercio->review_lines ?? 4 ); ?>;"><?php echo esc_html( $review['text'] ); ?></p>
    ...
    <!-- Paginación JS -->
    <div class="jjrc-pagination" data-uid="<?php echo esc_attr( $uid ); ?>"></div>
